...
public class WeatherProvider extends ContentProvider {
    ...
    /*
        Match each URI to WEATHER, WEATHER_WITH_LOCATION, WEATHER_WITH_LOCATION_AND_DATE,
        and LOCATION integer constants.
     */
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE: // Can only return 1 row
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            default:
                throw new UnsupportedOperationException("Unknown uri to delete: " + uri);
        }
    ...
    public int update(
        ...
        switch (match) {
            ...
            default:
                throw new UnsupportedOperationException("Unknown uri to update: " + uri);
        }
        if (rowsUpdated > 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
